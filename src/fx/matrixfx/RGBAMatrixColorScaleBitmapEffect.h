...
class RGBAMatrixColorScaleBitmapEffect : public MatrixBitmapEffectBase<RGBAColor>
{
public:
   ...
   virtual std::string GetXmlElementName() const override { return "RGBAMatrixColorScaleBitmapEffect"; }
